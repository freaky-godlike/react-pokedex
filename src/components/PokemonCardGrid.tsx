...
import { removePokemon } from "../app/reducers/removePokemonToList";
            ...
            (data: userPokemonsType) => {
              return (
                <div className="pokemon-card" key={data.id}>
                  ...
                  className="pokemon-card-image" loading="lazy" onClick={() => {
